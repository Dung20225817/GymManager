  ...
  <div class="app-container">
    ...
    <div class="main-content">
      <div class="header-actions">
        <h1 class="title">Danh sách buổi tập của khách hàng</h1>

        <div class="formAction">
          <button @click="toggleAddForm" class="add-button">
            <span v-if="!showAddForm">+ Thêm buổi tập mới</span>
            <span v-else>Ẩn form</span>
          </button>

          <button @click="toggleUpdateForm" class="update-button">
            <span v-if="!showUpdateForm"> Cập nhật buổi tập</span>
            <span v-else>Ẩn form</span>
          </button>
        </div>
      </div>
      ...
      <div v-if="showAddForm" class="form-container">
        <h2 class="form-title">Thêm buổi tập mới</h2>
        ...
        <form @submit.prevent="submitClass" class="add-form">
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="submit-button" :disabled="isLoading">
              ...
              <span v-else>Thêm buổi tập</span>
            </button>
          </div>
        </form>
      </div>
      ...
      <div v-if="showUpdateForm" class="form-container">
        <h2 class="form-title">Sửa buổi tập</h2>
